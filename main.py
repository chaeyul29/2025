...
# Streamlit UI
st.set_page_config(page_title="MBTI Career Guide", page_icon="🌟", layout="centered")

st.markdown("""
    <h1 style='text-align: center; color: #ff6f61;'>✨ MBTI 기반 진로 추천 사이트 ✨</h1>
...
if selected_mbti:
    st.markdown(f"""
        <h2 style='color:#6a5acd;'>🌈 {selected_mbti} 유형에 추천하는 직업 🌈</h2>
    """, unsafe_allow_html=True)
...
st.markdown("""
---
<p style='text-align:center;'>💖 Made with Streamlit 💖</p>
""", unsafe_allow_html=True)
